    ...
    <header className="fixed top-0 inset-x-0 z-50 h-16 bg-background border-b border-border">
      <div className="max-w-7xl mx-auto h-full flex items-center justify-between px-4 sm:px-6">
        ...
        <div className="hidden lg:flex items-center gap-3">
          {session?.user ? (
            <>
              <Link href="/mypage" className="flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground transition-colors">
            ...
            <Button variant="ghost" size="sm" onClick={() => signIn()} className="text-muted-foreground">
